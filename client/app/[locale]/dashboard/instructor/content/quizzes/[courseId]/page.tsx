  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        console.log('Raw quizzes data:', quizzesRes.data.quizzes)
                          ...
                          <ul className='ml-4 mt-1 space-y-2'>
                            {lectureQuizzes.map((quiz) => (
                              ...
                              >
                                ...
                                <Link
                                  href={`/dashboard/instructor/content/quizzes/${courseId}/${section._id}/${lecture._id}/edit-lecture-quiz?quizId=${quiz._id}`}
                ...
                {quizzes
                  ...
                  .map((quiz) => (
                    ...
                    >
                      ...
                      <Link
                        href={`/dashboard/instructor/content/quizzes/${courseId}/${section._id}/edit-section-quiz?quizId=${quiz._id}`}
                        className='text-blue-500 hover:underline text-xs'
                      >
                        Edit
                      </Link>
