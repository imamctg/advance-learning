...
//     setProgress({ percentage: 0, message: 'Starting upload...' })
...
//       setProgress({ percentage: 0, message: 'Uploading files to server...' })
...
//       setProgress({ percentage: 100, message: 'Finalizing course creation...' })

//       // Optional: Add small delay to show 100% completion
...
//     if (field === 'file' || field === 'resourceFile') {
...
//           if (lecture.resourceFile) totalFiles++ // resource file
//         })
//       })
...
//                     {lecture.resourceFile && (
//                       <div className='text-sm text-green-600 mt-1'>
//                         Selected: {lecture.resourceFile.name}
//                       </div>
//                     )}
//                   </div>
