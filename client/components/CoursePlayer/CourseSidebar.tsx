...
//     //                       Lecture {sectionIndex + 1}.{lectureIndex + 1}:{' '}
//     //                       {lecture.title} {/* Numbering যোগ করুন */}
//     //                     </p>
//     //                     <p className='text-xs text-gray-500 mt-1'>
//     //                       ⏱{' '}
...
//     //           {/* Section Assignment (Optional UI Block) */}
//     //           {/* {section.assignment && (
//     //             <div className='mt-4 ml-2'>
//     //               <div className='text-xs text-purple-600 mb-1'>📄 Assignment Available</div>
//     //               <button
//     //                 onClick={() => alert('Assignment Open')}
//     //                 className='inline-flex items-center gap-1 text-xs text-purple-700 bg-purple-50 px-2 py-1 rounded-full border border-purple-100 hover:bg-purple-100 transition'
//     //               >
//     //                 <span className='text-sm'>🧾</span>
